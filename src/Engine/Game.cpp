...
bool Game::checkBoxCollision(SDL_Rect* a, SDL_Rect* b){
    if(a->x + a->w > b->x && a->x < b->x + b->w
       && a->y + a->h > b->y && a->y < b->y + b->h) return true;
    else return false;
}
    ...
    if(typeOfGame == TypeOfGame::PLAYABLE){
        ...
        while( SDL_PollEvent( &e ) != 0 ){
            ...
            if( e.type == SDL_KEYDOWN && e.key.repeat == 0){
                ...
                case SDLK_a: command = InputCommands::SDLK_a_DOWN; break;
                    case SDLK_d: command = InputCommands::SDLK_d_DOWN; break;
                    case SDLK_w: command = InputCommands::SDLK_w_DOWN; break;
                    case SDLK_SPACE: command = InputCommands::SDLK_SPACE_DOWN; break;
                    case SDLK_1: command = InputCommands::SDLK_1_DOWN; break;
                    case SDLK_2: command = InputCommands::SDLK_2_DOWN; break;
                    case SDLK_3: command = InputCommands::SDLK_3_DOWN; break;
                    case SDLK_q: command = InputCommands::SDLK_q_DOWN; break;
                    case SDLK_e: command = InputCommands::SDLK_e_DOWN; break;
                }
                ...
                switch( e.key.keysym.sym ){
                    case SDLK_a: command = InputCommands::SDLK_a_UP; break;
                    case SDLK_d: command = InputCommands::SDLK_d_UP; break;
                    case SDLK_w: command = InputCommands::SDLK_w_UP; break;
                    case SDLK_SPACE: command = InputCommands::SDLK_SPACE_UP; break;
                    case SDLK_1: command = InputCommands::SDLK_1_UP; break;
                    case SDLK_2: command = InputCommands::SDLK_2_UP; break;
                    case SDLK_3: command = InputCommands::SDLK_3_UP; break;
                    case SDLK_q: command = InputCommands::SDLK_q_UP; break;
                    case SDLK_e: command = InputCommands::SDLK_e_UP; break;
            ...
            switch(command){
                case InputCommands::SDLK_a_DOWN: p1->keys[(int)Player::Keys::LEFT] = true; break;
                case InputCommands::SDLK_d_DOWN: p1->keys[(int)Player::Keys::RIGHT] = true; break;
                case InputCommands::SDLK_w_DOWN: p1->keys[(int)Player::Keys::UP] = true; break;
                case InputCommands::SDLK_SPACE_DOWN: p1->keys[(int)Player::Keys::SPACE] = true; break;
                case InputCommands::SDLK_1_DOWN: p1->keys[(int)Player::Keys::NUM1] = true; break;
                case InputCommands::SDLK_2_DOWN: p1->keys[(int)Player::Keys::NUM2] = true; break;
                case InputCommands::SDLK_3_DOWN: p1->keys[(int)Player::Keys::NUM3] = true; break;
                case InputCommands::SDLK_q_DOWN: p1->keys[(int)Player::Keys::Q] = true; break;
                case InputCommands::SDLK_e_DOWN: p1->keys[(int)Player::Keys::E] = true; break;

                case InputCommands::SDLK_a_UP: p1->keys[(int)Player::Keys::LEFT] = false; break;
                case InputCommands::SDLK_d_UP: p1->keys[(int)Player::Keys::RIGHT] = false; break;
                case InputCommands::SDLK_w_UP: p1->keys[(int)Player::Keys::UP] = false; break;
                case InputCommands::SDLK_SPACE_UP: p1->keys[(int)Player::Keys::SPACE] = false; break;
                case InputCommands::SDLK_1_UP: p1->keys[(int)Player::Keys::NUM1] = false; break;
                case InputCommands::SDLK_2_UP: p1->keys[(int)Player::Keys::NUM2] = false; break;
                case InputCommands::SDLK_3_UP: p1->keys[(int)Player::Keys::NUM3] = false; break;
                case InputCommands::SDLK_q_UP: p1->keys[(int)Player::Keys::Q] = false; break;
                case InputCommands::SDLK_e_UP: p1->keys[(int)Player::Keys::E] = false; break;
