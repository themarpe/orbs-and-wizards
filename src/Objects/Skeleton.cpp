...
void Skeleton::render(Camera* camera){
    ...
    //sets color mod
    if(hitDuration > 0)SDL_SetTextureColorMod(Game::SPRITESHEET.at(spriteSheetKey).getSheetTexture(), 255,32,32);
    else if(frozenDuration > 0) SDL_SetTextureColorMod(Game::SPRITESHEET.at(spriteSheetKey).getSheetTexture(), 32,32,128);
